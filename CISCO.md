...
## 명령어
>[!danger] 보안 명령어는 순서가 극히 중요함! 늘  먼저 할 것!
...
>[!quote] 🛑 확장 ACL (Extended ACL) 심화 옵션 해부
>[!abstract] Standard vs Extended
> - **Standard (1~99):** 출발지 IP만 검사. (무식함)
> - **Extended (100~199):** 프로토콜, 출발지 IP, 목적지 IP, 포트 번호까지 핀셋 검사. (정교함)
